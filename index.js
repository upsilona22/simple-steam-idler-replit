...
var games = [730, 440, 570, 218];  // Enter here AppIDs of the needed games
var status = 1;  // 1 - online, 7 - invisible


user = new steamUser();
user.logOn({"accountName": username, "password": password }); //"twoFactorCode": steamTotp.geerateAuthCode(shared_secret)});
user.on('loggedOn', () => {
